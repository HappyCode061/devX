...
class ChatControllerTest {
    ...
    void returnsGroundedDraftAnswer() throws Exception {
        ChatAskRequest request = new ChatAskRequest("How do we validate PostgreSQL setup?", 5);
        ...
        given(chatService.ask(request.question(), request.retrievalLimit())).willReturn(response);
    ...
    void rejectsBlankQuestion() throws Exception {
        ChatAskRequest request = new ChatAskRequest("", 5);
